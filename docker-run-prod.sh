...
docker run -d --net="host" -v $PWD:/var/www/webapp:ro --name simplecases-rails-prod claudevandort/simplecases-rails:prod
#docker run --net="host" -v $PWD:/var/www/webapp:ro --name simplecases-rails-prod -i -t claudevandort/simplecases-rails:prod /bin/bash
